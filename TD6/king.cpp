...
model::King::King(const Color& color) :
    Piece(color)
{
...
bool model::King::isConfrontingAdversaryKing(const std::pair<int, int>& possibleMove, const std::pair<int, int>& opposingKingPosition) const
{
...
void model::King::calculatePossibleMovements(const std::pair<int, int>& initialPosition, Board* board)
{
    calculatePossibleSimpleMovements(initialPosition, board);
}

void model::King::calculatePossibleSimpleMovements(const std::pair<int, int>& initialPosition, Board* board)
{
    using namespace std;
...
char model::King::getName() const
{
    return BLACK_KING;
}

char model::King::getCharacter() const
{
